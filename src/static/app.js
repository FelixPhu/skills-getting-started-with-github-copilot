document.addEventListener("DOMContentLoaded", () => {
  ...
  function formatParticipantName(participant) {
    ...
    const rawName = participant.includes("@") ? participant.split("@")[0] : participant;
    return rawName
      .replace(/[._-]+/g, " ")
      .trim()
      .split(/\s+/)
          ...
          .map(
            (participant) => `
              <div class="participant-row">
                <span class="participant-name">${formatParticipantName(participant)}</span>
                <button
                  type="button"
                  class="remove-participant-btn"
                  data-activity="${name}"
                  data-email="${participant}"
                  aria-label="Unregister ${formatParticipantName(participant)}"
                  title="Unregister"
                >
        ...
        activityCard.innerHTML = `
          ...
          <div class="participants-section">
            ...
            <div class="participants-list" role="list">
              ${participantsMarkup || "<p class=\"empty-participants\">No participants yet</p>"}
            </div>
          </div>
        `;
